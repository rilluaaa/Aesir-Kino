...
export const simplifiedContent = {
  ...
  hero: {
    ...
    description: "以高端、富有电影感的视角，呈现 AESIR 在 SEN 干预、积极老龄化、康复及运动科技方面的生态系统。",
    descriptionSegments: ["以高端、富有电影感的视角，", "呈现 AESIR 在 SEN 干预、", "积极老龄化、康复及运动科技方面的生态系统。"],
  ...
  featuresSection: {
    ...
    features: [
      ...
      { eyebrow: "影响力智能", title: "为照护团队、NGO 及合作伙伴打造的数据层。", description: "AESIR 将一线学习与康复活动转化为可量化的覆盖范围、参与度及成效指标。", metric: "50,000+", metricLabel: "训练数据点" }
    ]
  },
  ...
  founderStory: {
    ...
    principles: [
      { title: "研究是关键", body: "每个互动平台都被设计为可量化的干预方案，以心理学及临床验证为基础，而不仅仅是娱乐体验。" },
  ...
  roadmap: {
    ...
    items: [
      ...
      { number: "02", title: "普惠可及", body: "通过学校、康复中心、NGO 及国际科研合作伙伴，进一步扩大临床验证及包容性技术的可及性。" }
    ],
    directionLabel: "发展方向",
