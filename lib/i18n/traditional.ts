...
export const traditionalContent = {
  ...
  hero: {
    ...
    description: "以高端而具電影感的視角，呈現 AESIR 在 SEN 介入、積極樂齡、復康及運動科技方面的生態系統。",
    descriptionSegments: ["以高端而具電影感的視角，", "呈現 AESIR 在 SEN 介入、", "積極樂齡、復康及運動科技方面的生態系統。"],
  ...
  featuresSection: {
    ...
    features: [
      ...
      { eyebrow: "影響力智能", title: "為照護團隊、NGO 及合作夥伴而設的數據層。", description: "AESIR 將前線學習與復康活動轉化為可量化的觸及範圍、參與度及成效指標。", metric: "50,000+", metricLabel: "訓練數據點" }
    ]
  },
  ...
  founderStory: {
    ...
    principles: [
      { title: "研究是關鍵", body: "每個互動平台都被設計成可量化的介入方案，以心理學及臨床驗證為基礎，而不只是娛樂體驗。" },
  ...
  roadmap: {
    ...
    items: [
      ...
      { number: "02", title: "全面可及", body: "透過學校、復康中心、NGO 及國際研究合作夥伴，進一步擴展臨床驗證及共融科技的可及性。" }
    ],
    directionLabel: "發展方向",
