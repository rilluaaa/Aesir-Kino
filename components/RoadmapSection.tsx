...
type RoadmapSectionProps = {
  readonly content: SiteContent["roadmap"];
};
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <MotionReveal className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-6 md:flex-row md:items-center md:justify-between" delay={0.1}>
          <p className="i18n-label text-xs font-bold uppercase tracking-[0.22em] text-white/45">
            <CjkText>{content.directionLabel}</CjkText>
          </p>
          <p className="max-w-3xl text-right text-sm leading-6 text-white/70">
            <CjkText>{content.direction}</CjkText>
          </p>
        </MotionReveal>
      </div>
    </section>
