...
import type { PartnerValidation } from "@/lib/i18n/types";

type PartnerValidationSectionProps = {
  readonly content: PartnerValidation;
};

export function PartnerValidationSection({ content }: PartnerValidationSectionProps) {
  return (
